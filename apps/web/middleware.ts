...
// Rutas solo para miembros del club
...
export async function middleware(request: NextRequest) {
  ...
  try {
    ...
    if (isAdminRoute && !['owner', 'admin', 'employee'].includes(role)) {
    ...
    // Pasar el user ID y rol en headers para que los Server Components los lean
